...
const Chatbot = () => {
    ...
    const keywordResponses = {
        ...
        "What does your project do?": "The Research Nexus project aims to foster collaboration and knowledge exchange across various research disciplines to promote innovation and advancements in science and technology.",
        ...
        "team": "Thanks to Suryanshi Sharma, Khushi Agarwal, Sahej Prakash, Arpit Kochar, Kuljot Singh for their support!",
        ...
        "login": "Access your account with login. You must click on the button 'research nexus' to invoke the interface. You must be an Emory Student to log in. ",
