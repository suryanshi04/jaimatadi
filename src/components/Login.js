...
function Login(){
  ...
  return(
    ...
    <div className="login-form-wrapper">
      <div className="eLogo">
        <img src="1.png" alt="not available"/>
      </div>
      ...
      <div className="blue-bg">
        ...
        <button type="button" onClick={() => handleButtonClick()}>{isChange ? 'Home' : 'Research Nexus'}</button>
      </div>
      <form className="signin-form" onSubmit={handleFormSubmit}>
        <h1>Research Nexus!</h1>
        <h1>Login</h1>
        <p>Please enter your credentials to log in to Research Nexus!</p>
