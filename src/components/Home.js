          ...
          <div className="col-12">
            ...
            <div className="row justify-content-center ">
              ...
              <div className="col-lg-6 text-center ">
                <Link to={'/'} href="https://vimeo.com/342333493" data-fancybox data-aos="fade-up" data-aos-delay="0" className="caption mb-4 d-inline-block">Research Nexus!</Link>
      ...
      <div className="container">
        ...
        <div className="row justify-content-center" data-aos="fade-up" data-aos-delay="400">
          <div className="col-lg-8 text-center">
            <p>Learn more about research recruiting <Link to="Applications">Browse all</Link></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="container">
        <div className="row justify-content-center mb-5">
          <div className="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
            ...
            <p>Explore research projects in the Computer Science Department</p>
          </div>
        </div>
        <div className="row">
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-7 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <h2 className="line-bottom mb-4">The Mission Behind Research Nexus!</h2>
                ...
                <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordion_1">
                  <div className="accordion-body">
                    <div className="d-flex">
                      <div>
                        <p>Research Nexus offers a platform for in-coming students to avoid the awkwardness of cold emails</p>
